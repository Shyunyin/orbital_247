...
<html>
    ...
    <body>
        ...
        <div id="routine">
            ...
            <div id="box">
                <input id="test1" type="button" value="Daily: 12:00PM-01:00PM Lunch (Meal Times)" onclick="tempFixed();">
                <input id="test2" type="button" value="Daily: 07:00PM-08:00PM Dinner (Meal Times)" onclick="tempFixed();">
                <input id="test3" type="button" value="Weekly: Friday 06:00PM-07:00PM Running (Meal Times)" onclick="tempFixed();">
            </div> 
            <div id="tasklist"> 
